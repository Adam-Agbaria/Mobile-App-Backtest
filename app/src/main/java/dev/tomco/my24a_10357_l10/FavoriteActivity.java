...
public class FavoriteActivity extends AppCompatActivity {
    ...
    private void loadFavoriteResults() {
        ...
        ref.orderByChild("userId").equalTo(userId).addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                for (Map<String, Object> data : dataList) {
                    if (data != null && data.containsKey("bundleData")) {
                        ...
                        if (bundleData != null && !bundleData.isEmpty()) {
                            Utils.createChartWithData(FavoriteActivity.this, layoutContainer, bundleData, strategyName, tp, sl, totalProfit, winPercentage);
                        }
                    } else {
                        Log.e("FavoriteActivity", "No 'bundleData' key found.");
                    }
                }
            }
            ...
            public void onCancelled(DatabaseError databaseError) {
                Log.e("FavoriteActivity", "Database error: " + databaseError.getMessage());
            }
        });
    }
}